            ...
            <div class="col-12">
              ...
              <div class="card shadow mb-4 ">
                ...
                <div class="card-body"> 
                    ...
                    <form action="<?=base_url('admin/control_admin_aboutschool/').$action;?>" method="post" enctype="multipart/form-data">
                      <div class="form-group row">
                        <label for="about_id" class="col-sm-2 col-form-label">รหัส</label>
                        <div class="col-sm-10">
                          <input type="text" readonly  class="form-control" id="about_id" name="about_id" value="<?=$action == 'insert_aboutschool' ? $aboutschool : $aboutschool[0]->about_id;?>" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="about_menu" class="col-sm-2 col-form-label">ชื่อเมนู</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="about_menu" name="about_menu" value="<?=$action == 'insert_aboutschool' ? '' : $aboutschool[0]->about_menu;?>" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="about_detail" class="col-sm-2 col-form-label">เนื้อหา</label>
                        <div class="col-sm-10">
                          <textarea class="form-control" name="about_detail" id="about_detail" > <?=$action == 'insert_aboutschool' ? '' : $aboutschool[0]->about_detail;?></textarea>
                        </div>
                      </div>
