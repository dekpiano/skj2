            ...
            <div class="col-12">
              ...
              <div class="card shadow mb-4 ">
                ...
                <div class="card-body"> 
                    ...
                    <form action="<?=base_url('admin/control_admin_position/').$action;?>" method="post">
                      <div class="form-group row">
                        <label for="posi_id" class="col-sm-2 col-form-label">รหัส<?=$title;?></label>
                        <div class="col-sm-10">
                          <input type="text" readonly  class="form-control" id="posi_id" name="posi_id" value="<?=$action == 'insert_position' ? $position : $posi[0]->posi_id;?>" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="posi_name" class="col-sm-2 col-form-label">ชื่อ<?=$title;?></label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="posi_name" name="posi_name" value="<?=$action == 'insert_position' ? '' : $posi[0]->posi_name;?>" required>
                        </div>
                      </div>
                       <div class="form-group row">
