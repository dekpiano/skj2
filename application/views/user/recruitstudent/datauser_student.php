<div class="section layout_padding">
    <div class="container">
        ...
        </div> <a href="<?=base_url('RegStudent')?>" class="btn btn-outline-primary">< กลับหน้าหลัก</a>
    </div>
</div>
        ...
        <div class="card-body">
            ...
            <div class="col-md-12 order-md-1">
                ...
                <form class="needs-validation" enctype="multipart/form-data" method="post" novalidate=""
                    action="<?=base_url('control_recruitstudent/reg_update/').$stu->recruit_id.'/'.($stu->recruit_img=='' ? '0' : $stu->recruit_img);?>">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" id="recruit_idCard" name="recruit_idCard" required
                                value="<?=$stu->recruit_idCard?>" data-inputmask="'mask': '9-9999-99999-99-9'">
                  ...
                  ?>
                                <option <?=$stu->recruit_prefix == $value ? 'selected' : ''; ?> value="<?=$value;?>">
                                    <?=$value;?></option>
                                <?php endforeach; ?>
                            </select>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-md-5 mb-3">
                            ...
                            <input type="text" class="form-control" id="recruit_firstName" name="recruit_firstName"
                                value="<?=$stu->recruit_firstName?>" required>
                            <div class="invalid-feedback">
                                ระบุชื่อจริง
                            </div>
                        </div>
                        <div class="col-md-5 mb-3">
                            ...
                            <input type="text" class="form-control" id="recruit_lastName" name="recruit_lastName"
                                value="<?=$stu->recruit_lastName?>" required>
                            <div class="invalid-feedback">
                                ระบุนามสกุล
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="recruit_oldSchool" name="recruit_oldSchool"
                                value="<?=$stu->recruit_oldSchool?>" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" class="form-control" id="recruit_district" name="recruit_district"
                                value="<?=$stu->recruit_district?>" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" class="form-control" id="recruit_province" name="recruit_province"
                                value="<?=$stu->recruit_province?>" required>
                            <div class="invalid-feedback">
            ...
            ?>
                      ...
                      for ($i=($year-30);$i<=($year);$i++) : ?>
                        ...
                        <div class="col-md-2 mb-3">
                            ...
                            <input type="text" class="form-control" id="recruit_nationality" name="recruit_nationality"
                                value="<?=$stu->recruit_nationality?>" required>
                            <div class="invalid-feedback">
                                ระบุสัญชาติ
                            </div>
                        </div>
                        <div class="col-md-2 mb-3">
                            ...
                            <input type="text" class="form-control" id="recruit_religion" name="recruit_religion"
                                value="<?=$stu->recruit_religion?>" required>
                            <div class="invalid-feedback">
                                ระบุศาสนา
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-2 mb-3">
                            ...
                            <input type="text" class="form-control" id="  recruit_homeNumber" name=" recruit_homeNumber"
                                value="<?=$stu->recruit_homeNumber?>" required>
                            <div class="invalid-feedback">
                                ระบุเลขที่บ้าน
                            </div>
                        </div>
                        <div class="col-md-1 mb-3">
                            ...
                            <input type="text" class="form-control" id="recruit_homeGroup" name="recruit_homeGroup"
                                value="<?=$stu->recruit_homeGroup;?>" required>
                            <div class="invalid-feedback">
                                ระบุหมู่ที่
                            </div>
                        </div>
                        ...
                        <div class="col-md-2 mb-3">
                            ...
                            <input type="text" class="form-control" id="recruit_homeSubdistrict"
                                name="recruit_homeSubdistrict" value="<?=$stu->recruit_homeSubdistrict;?>" required>
                            <div class="invalid-feedback">
                                ระบุตำบล/แขวง
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" id="recruit_phone" name="recruit_phone"
                                value="<?=$stu->recruit_phone?>" required data-inputmask="'mask': '99-9999-9999'">
                            <div class="invalid-feedback">
                  ...
                  foreach ($AtpyeRoom as $key => $v_AtpyeRoom) : ?>
                    ...
                    <div class="custom-control custom-checkbox text-center ">
                        <input type="checkbox" class="custom-control-input" id="check_proviso" name="check_proviso"
                            value="1" required>
